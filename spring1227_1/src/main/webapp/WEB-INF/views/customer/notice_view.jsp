				...
				<div id="customer">
					  ...
					  $(function(){
						...
						//댓글 수정 저장
						  $(document).on("click",".saveBtn",function(){
							  alert("댓글 수정 내용을 저장합니다.");
							  alert($(this).parent().parent().attr("id"));
							  alert("${session_id}");
							  alert($(this).parent().parent().find("span").text());
							  alert($(this).parent().prev().find(".replyType").val());
							  
							  let cno = $(this).parent().parent().attr("id"); //attr()-속성값
							  let id = "Service에서 id를 가져올 것";
							  let cdate = "새롭게 저장한 시간";
							  let ccontent = $(this).parent().prev().find(".replyType").val(); //parent()-부모, find()-현재 태그에 포함된 id를 찾아줘 
						...
						//댓글 수정 취소
						  $(document).on("click",".cancelBtn",function(){
							  ...
							  let id = "${session_id}";
							  let cdate = $(this).parent().parent().find("span").text();
							  //parent()-부모, find()-현재 태그에 포함된 id를 찾아줘
					...
					<div class="replyBox">
						...
						<ul>
							...
							<li class="btn">
								<a class="rebtn savrBtn" style="cursor: pointer;">저장</a>

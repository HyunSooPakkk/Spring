...
<!-- End Header -->
  ...
  <div class="section-header">
          <h2>날씨</h2>
          <p><span style="font-family: 'Rubik Doodle Shadow', system-ui;">CampBridge</span>
          <span style="font-family:'Noto Sans KR', sans-serif";>가 날씨를 안내해드립니다.</span></p>
        </div>
        <div id="weather_bg">
    ...
    <section id="events" class="events">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>추천</h2>
          <p><span style="font-family: 'Rubik Doodle Shadow', system-ui;">CampBridge</span>
          <span style="font-family:'Noto Sans KR', sans-serif;">의 추천</span></p>
        </div>

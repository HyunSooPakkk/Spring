...
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
    ...
    <style>
        *{margin: 0; padding: 0;}
        ...
        #h_logo{display: block; overflow: hidden; width: 231px; height: 44px;
            	margin: 0 auto; font-size: 15px; color: transparent;
...
<div id="wrap">
    <div id="header">
    <form name="m_frm" method="get" action="/mLogin">
        <h1>
            <a href="#" id="h_logo"></a>
        </h1>
    </div>
        ...
        <div id="content">
            ...
            <form action="mLogin">
                <fieldset style="border: 0">
                    ...
                    <a href="/"><input class="btn_login" type="submit" value="로그인"></a>
                </fieldset>
            </form>
        </div>
    </div>

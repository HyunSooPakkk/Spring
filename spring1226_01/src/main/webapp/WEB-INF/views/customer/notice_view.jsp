				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								<p class="txt">작성일
								<span><fmt:formatDate value="${map.bdto.bdate}" pattern="yyyy-MM-dd"/></span></p>
							</div>
						</div>

						<div class="viewContents">${map.bdto.bcont}
						<br><br>
						...
						$(function(){
							...
							$(".replyBtn").click(function(){
								...
								$.ajax({
									...
									type: "post", //get, post
									data: { "ccontent": ccontent, "cpw": cpw, "bno": bno }, //데이터를 개별적으로 보냄
									//data: $("#memberFrm").serialize(), //복수개의 데이터 보낼경우 : form에있는 모든 입력데이터를 한번에 전송 : $(form태크 id값).serialize()
									dataType: "json", //받는 파일형태 - text, json, xml
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>																
								...
								<li><a href="#" class="sbtnMini">목록</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->

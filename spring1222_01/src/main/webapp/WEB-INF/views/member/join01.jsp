...
<html>
	...
	<body>
			...
			$(function(){
				$("#idChkBtn").click(function(){
					...
					$.ajax({
						...
						data: $("#agreeFrm").serialize(), //복수개의 데이터 보낼경우 : form에있는 모든 입력데이터를 한번에 전송 : $(form태그 id값).serialize()
						dataType: "json", //받는 파일형태 - text, json, xml
						//contentType:"json", ※필요시 사용 내가 보내는 파일형태
				...
				//$("#idChkBtn").click(()=>{    //익명함수, 화살표함수 6.0버전
		...
		<section>
			<form name="agreeFrm" id="agreeFrm" method="post" action="join01">

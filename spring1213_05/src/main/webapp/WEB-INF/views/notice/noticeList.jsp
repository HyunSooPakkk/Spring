...
<html>
	...
	<body>
		<div>
		<form name="b_frm" method="get" action="notice/noticeInsert" enctype="multipart/form-data">
		   <h1>게시판</h1>
		   <!-- 검색부분 -->
		   <div class="wrapper">
		   ...
		   <a href="noticeInsert"><button type="button" id="insert_fbtn">글쓰기</button></a>
		   <a href="/"><button type="button" id="home_fbtn">홈으로</button></a>
		</div>
